...
# Plot the results of the test proedictions

plt.plot(actual_prices, color='red', label='Actual Prices')
plt.plot(predicted_prices, color='green', label='Predicted Prices')

plt.title('yahoole Stock Price Prediction')
plt.xlabel('Time')
plt.ylabel('yahoole Stock Price')
plt.legend()
plt.show()


# Predit the future price of the stock(Next Day)
